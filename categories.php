    	...
    	<form class="form-horizontal" id="submitCategoriesForm" action="php_action/createCategories.php" method="POST">
	      ...
	      <div class="modal-body">
			  ...
			  <div class="form-group">
	        	<label for="StoreID" class="col-sm-4 control-label">Store ID: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="StoreID" placeholder="StoreID" name="StoreID" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
	        <div class="form-group">
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="Size" placeholder="Size" name="Size" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
			<div class="form-group">
	        	<label for="BrandID" class="col-sm-4 control-label">Brand ID: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="Brandid" placeholder="Brandid" name="Brandid" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	                 	        
	      </div> <!-- /modal-body -->
