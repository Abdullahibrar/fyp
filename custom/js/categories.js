...
$(document).ready(function() {
	...
	$('#addCategoriesModalBtn').unbind('click').bind('click', function() {
		...
		$("#submitCategoriesForm").unbind('submit').bind('submit', function() {
			...
			if(StoreID == "") {
				$("#StoreID").after('<p class="text-danger">Store ID field is required</p>');
				$('#StoreID').closest('.form-group').addClass('has-error');
			} else {
				// remov error text field
				$("#StoreID").find('.text-danger').remove();
				// success out for form 
				$("#StoreID").closest('.form-group').addClass('has-success');	  	
			}

			if(Brand == "") {
				$("#Brand").after('<p class="text-danger">Brand Name field is required</p>');
				$('#Brand').closest('.form-group').addClass('has-error');
			} else {
				// remov error text field
				$("#Brand").find('.text-danger').remove();
				// success out for form 
				$("#Brand").closest('.form-group').addClass('has-success');	  	
			}
			if(Location == "") {
				$("#Location").after('<p class="text-danger">Store ID field is required</p>');
			...
			if(Size == "") {
				$("#Size").after('<p class="text-danger">Store ID field is required</p>');
				$('#Size').closest('.form-group').addClass('has-error');
			} else {
				// remov error text field
				$("#Size").find('.text-danger').remove();
				// success out for form 
				$("#Size").closest('.form-group').addClass('has-success');	  	
			}

			if(BrandID == "") {
				$("#BrandID").after('<p class="text-danger">Store ID field is required</p>');
				$('#BrandID').closest('.form-group').addClass('has-error');
			} else {
				// remov error text field
				$("#BrandID").find('.text-danger').remove();
				// success out for form 
				$("#BrandID").closest('.form-group').addClass('has-success');	  	
			}

			if(StoreID && Location && Size && Brand && BrandID) {
				var form = $(this);
				// button loading
