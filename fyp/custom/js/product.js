...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(NodeID == "") {
				$("#NodeID").closest('.center-block').after('<p class="text-danger">Product Image field is required</p>');
				$('#NodeID').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#NodeID").find('.text-danger').remove();
				// success out for form 
				$("#NodeID").closest('.form-group').addClass('has-success');	  	
			}	// /else
			if(StoreID == "") {
				$("#StoreID").after('<p class="text-danger">Product Name field is required</p>');
